...
REAL ONLY -- NO MOCK MODE: every pykep adapter requires pykep installed;
the example exits with install instructions otherwise.
...
WHAT THIS EXAMPLE DOES:
    ...
    6. Complete mission: LEO escape burn (patched conic) + interplanetary arc
"""
