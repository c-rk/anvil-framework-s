...
===============================================================
Demonstrates openmdo_sellar, openmdo_beam, and the make_openmdo_adapter
factory. There is no mock mode: if OpenMDAO is not installed the example
exits with install instructions.
