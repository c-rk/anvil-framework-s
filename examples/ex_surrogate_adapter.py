...
===================================
Demonstrates make_poly_adapter, make_rbf_adapter (real methods on Anvil's
core numpy/scipy dependencies) plus make_gp_adapter / gp_demo, which require
scikit-learn -- no mock fallback: the GP sections are skipped if sklearn is
not installed.

Install GP support: pip install scikit-learn
"""
import sys, os
